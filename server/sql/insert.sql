...
insert into synchshop.list (name, code) values 
    ('list1', 'list1code');

insert into synchshop.list (name, code) values 
    ('list2', 'list2code');

insert into synshop.product (list_id, name, date, bought, categories, priority) values
...
insert into synshop.list_user (list_id, user_id) values
    (1, 1);
